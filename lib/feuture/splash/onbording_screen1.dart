...
class OnbordinScreen1 extends StatelessWidget {
  const OnbordinScreen1({super.key});
                      ...
                      children: [
                       ...
                       const SizedBox(height: 10,),
                        Row(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            CustomContainer1(ontab: (){}, color: AppColor.white),
                            const SizedBox(width: 10,),
                            CustomContainer(ontab: (){}, color: AppColor.bluColor),
                          ],
                        )
                      ],
                    ),
